...
Our paper **"To join or not to join: handling biological replicates in long-read RNA sequencing data"** has been accepted for publication in *Nature Communications* (preprint on [bioRxiv](https://www.biorxiv.org/), 2025).
...
As first author, I led the transcript reconstruction and benchmarking analysis (FLAIR, TALON, IsoQuant, Bambu, SQANTI3) across PacBio, ONT, and Illumina platforms.
